'''
    WARNING: DO NOT RUN THIS SCRIPT IF MOTORS ARE FULLY INTEGRATED. 
             This script is only for testing if motors & drivers are properly connected.
             Run this only when all the motors are uninstalled.
'''
